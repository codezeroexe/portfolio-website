  ...
  return (
        ...
        >
          ...
          <div className="flex gap-4 relative z-10">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="outline" onClick={() => scrollTo('contact')} className={`border-white/30 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-shadow ${isDark ? 'text-white hover:bg-white/10' : 'text-foreground hover:bg-foreground/10'}`}>Get In Touch</Button>
            </motion.div>
